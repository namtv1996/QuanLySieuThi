(function (app) {
    app.controller('purchaseReturnAddController', purchaseReturnAddController);

    purchaseReturnAddController.$inject = ['$scope', 'apiService', '$stateParams', 'notificationService', '$state'];
    function purchaseReturnAddController($scope, apiService, $stateParams, notificationService, $state) {
        $scope.inwardStock = {
            VoucherID: null,
            INVoucherNo: null,
            Status: null,
        ...
        function getPurchaseReturnByPartialStorage(voucherno) {
            var config = {
                params: {
                    voucherno: voucherno
                }
            }
            apiService.get('api/purchaseInvoice/getPurchaseReturnByPartialStorage', config,
                function (result) {
        ...
        function AddPurchaseReturn() {
            if ($scope.voucherDetail != []) {
                $scope.purchaseReturn.InwardStockID = $scope.inwardStock.InwardStockID;
        ...
        function GetVoucherDetail() {
            var config = {
                params: {
                    voucherno: $scope.inwardStock.INVoucherNo
                }
            }
            apiService.get('api/purchaseInvDetail/getbyid/' + $stateParams.id, null, function (result) {
                $scope.voucherDetail = result.data;

                apiService.get('api/purchaseInvDetail/getPurchaseReturnDetailByOVN', config,
                    function (result) {
                        var invoice_detail = [];
        ...
        function GetVoucherById() {
            apiService.get('api/purchaseInvoice/getbyid/' + $stateParams.id, null, function (result) {
                ...
                $scope.getPurchaseReturnByPartialStorage($scope.inwardStock.INVoucherNo);
            }, function (error) {
                notificationService.displayError(error.data);
            });
        }
